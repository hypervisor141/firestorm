...
public class FSM{
    ...
    public static VLListType<Data> decode(InputStream is, ByteOrder order, boolean fullsizedvertex) throws IOException{
        ...
        VLListType<Data> datacache = new VLListType<>(size, 0);
